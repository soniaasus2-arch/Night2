...
-- ============================================================
-- SISTEMA DE PERSONALIZAÇÃO DE AVATAR - DAVI HUB
-- ============================================================

local CustomizationSystem = {
    ConfigFile = "DAVI_HUB_Avatar.json",
    ...
    CurrentConfig = {
        ...
        Clothes = {},
        Faces = {},
        SkinColor = Color3.fromRGB(255, 200, 150)
    },
    
    Items = {
        Animations = {
            {id = 68, name = "Pacote de Animação Cavaleiro"},
            {id = 48, name = "Pacote de Animação Ancião"},
            {id = 79, name = "Pacote de Animação Levitação"},
            {id = 34, name = "Pacote de Animação Astronauta"},
            {id = 32, name = "Pacote de Animação Lobisomem"},
            {id = 33, name = "Pacote de Animação Vampiro"},
            {id = 75, name = "Pacote de Animação Ninja"}
        },
        Bodies = {
            {id = 34852431243411, name = "JOGO 6"},
            {id = 39259882311944, name = "Bloco de Desenho Estilizado"}
        },
        Accessories = {
            {id = 121059938714983, name = "Brilho Animado de Olho Vermelho Direito"},
            {id = 1952, name = "Sem Rosto"},
            {id = 132240248180655, name = "Fato de Listras de Mafioso Abandonado"},
            {id = 44714131664147, name = "Cabeça Padrão"},
            {id = 84612556341833, name = "Dominus Esmeralda Encantado"},
            {id = 18523057273, name = "Valk"},
            {id = 417457461, name = "Boné de Beisebol com R de Roblox"},
            {id = 84635053351374, name = "Fedora Vermelho Velho"},
            {id = 14416603824, name = "Cabeça de Noob Realista"},
            {id = 117643469071102, name = "Pulseira Clássica Retrô com Logotipo do ROBLOX 2010 Esquerda"},
            {id = 108800389985057, name = "Pulseira Clássica Retrô com Logotipo do ROBLOX 2010 Direita"},
            {id = 78838201027561, name = "O Fedora ROBLOX Clássico"},
            {id = 17884187022, name = "Velho Cowboy Australiano Preto Short Brimed Fedora"},
            {id = 114086514850566, name = "Óculos de Sol Ovais Y2K"},
            {id = 127952811268327, name = "Bandagem"},
            {id = 123544472235499, name = "Bandagem Branca Direita"},
            {id = 18459955826, name = "R6 Bandagens de Braço Direito"},
            {id = 79288401260677, name = "Chapéu de Capitão Pirata Clássico"},
            {id = 80265588168373, name = "Cinto de Engrenagem Clássico"},
            {id = 18492158330, name = "Chapéu Superior Ghosdeeri Clássico"},
            {id = 17505294067, name = "Clássico"},
            {id = 112685816944119, name = "Mochila Clássica"},
            {id = 75572715738138, name = "Capacete do Construtor Clássico"},
            {id = 17256481579, name = "Fones de Ouvido Bloxxer Clássicos"},
            {id = 123806205838017, name = "Envoltérios de Bandagem de Braço Sangrento 1.0"},
            {id = 17174260778, name = "Bolsa de Viagem"},
            {id = 94422826470233, name = "Faca de Ombro Amarrada"},
            {id = 117598451757783, name = "Suporte de Baú de Espada Conectado"},
            {id = 17337169716, name = "Peça de Fantasia de Espada Conectada"},
            {id = 114055835376020, name = "Jaqueta de Cintura Preta"},
            {id = 71574166581280, name = "Capa do Caçador da Noite Negra"}
        },
        Clothes = {
            {id = 6195289741, name = "Explorador Veterano"},
            {id = 15055916669, name = "Explorador"},
            {id = 134943450994915, name = "EXPLORADOR"},
            {id = 2555242959, name = "Explorador"},
            {id = 16408794105, name = "Bloxxer"},
            {id = 18179053481, name = "Bloxxer"},
            {id = 101469572903009, name = "Bloxxer"},
            {id = 11405194976, name = "Bloxxer"},
            {id = 109725687735947, name = "Bloxy-Cola"},
            {id = 10781574618, name = "Camisa de Bacon Ferida Roxa"},
            {id = 96423003882781, name = "CAPOTE Perna"},
            {id = 17571709322, name = "Ranger Veterano do NCR - PANTS"},
            {id = 15734420417, name = "O VETERANO"},
            {id = 11317144160, name = "Camisa Sangrando e Rasgada"},
            {id = 8429208541, name = "Sangrando Sem Violino"}
        },
        Faces = {
            {id = 28027401789827, name = "Zumbi Triste"},
            {id = 127663840542015, name = "Drool"},
            {id = 172999742060824, name = "Cara de Mirada Suspeita"},
            {id = 9088763016936, name = "Clássico Sorriso"},
            {id = 181296980098037, name = "Rosto Assustado de Civil"},
            {id = 181581576277301, name = "Rosto Assustador de Neko"}
        }
    }
}
...
function CustomizationSystem:SaveConfig()
    local data = {
    ...
    local success, err = writeFile(self.ConfigFile, jsonData)
    
    if success then
        print("💾 Configuração de avatar salva!")
        return true
    else
        warn("❌ Erro ao salvar configuração de avatar:", err)
        return false
    end
end

function CustomizationSystem:LoadConfig()
    local exists, data = readFile(self.ConfigFile)
    ...
    if exists and data then
        ...
        if success and decoded and decoded.Config then
            self.CurrentConfig = decoded.Config
            print("📂 Configuração de avatar carregada!")
            return true
        end
    end
...
function CustomizationSystem:CreateLocalAccessory(itemId, itemName)
    ...
    accessory.Name = itemName or "Acessório"
    accessory.Handle = handle
    
    local meshId = "rbxassetid://" .. tostring(itemId)
...
function CustomizationSystem:ApplyToCharacter()
    local character = player.Character
    if not character then
        return false
    end
    
    -- REMOVER ACESSÓRIOS ANTIGOS
    ...
    for _, part in ipairs(character:GetChildren()) do
        if part:IsA("BasePart") and part.Name ~= "HumanoidRootPart" then
            part.Color = self.CurrentConfig.SkinColor
        end
    end
    
    -- APLICAR ACESSÓRIOS
    for _, id in ipairs(self.CurrentConfig.Accessories or {}) do
        local accessory = self:CreateLocalAccessory(id, "Acessório")
        if accessory then
    ...
    if head then
        ...
        for _, id in ipairs(self.CurrentConfig.Faces or {}) do
            local faceDecal = Instance.new("Decal")
            faceDecal.Name = "Face"
            faceDecal.Texture = "rbxassetid://" .. tostring(id)
    ...
    if torso and self.CurrentConfig.Clothes and #self.CurrentConfig.Clothes > 0 then
        ...
        for _, id in ipairs(self.CurrentConfig.Clothes) do
            local shirtDecal = Instance.new("Decal")
            shirtDecal.Name = "Clothing"
            shirtDecal.Texture = "rbxassetid://" .. tostring(id)
            shirtDecal.Parent = torso
        end
    end
...
function CustomizationSystem:ApplyItem(category, itemId)
    if not category or not itemId then
        return false, "Categoria ou ID inválido"
    end
    
    local itemExists = false
    for _, item in ipairs(self.Items[category] or {}) do
    ...
    if not itemExists then
        return false, "Item não encontrado na categoria"
    end
    
    self.CurrentConfig[category] = self.CurrentConfig[category] or {}
    
    for _, id in ipairs(self.CurrentConfig[category]) do
        if id == itemId then
            return false, "Item já está aplicado"
        end
    end
    
    table.insert(self.CurrentConfig[category], itemId)
    self:SaveConfig()
    self:ApplyToCharacter()
    
    return true, "Item aplicado!"
end

function CustomizationSystem:RemoveItem(category, itemId)
    if not category or not itemId then
        return false, "Categoria ou ID inválido"
    end
    
    if not self.CurrentConfig[category] then
        return false, "Nenhum item nesta categoria"
    end
    
    for i, id in ipairs(self.CurrentConfig[category]) do
        if id == itemId then
            table.remove(self.CurrentConfig[category], i)
            self:SaveConfig()
            self:ApplyToCharacter()
    ...
    return false, "Item não encontrado na configuração"
end

function CustomizationSystem:SetSkinColor(color)
    self.CurrentConfig.SkinColor = color
    self:SaveConfig()
    self:ApplyToCharacter()
    return true, "Cor de pele atualizada!"
end

function CustomizationSystem:GetAppliedItems()
    local applied = {}
    
    for category, items in pairs(self.CurrentConfig) do
        if type(items) == "table" and category ~= "SkinColor" then
            for _, id in ipairs(items) do
                local name = "Item " .. tostring(id)
                for _, item in ipairs(self.Items[category] or {}) do
                    if item.id == id then
                        name = item.name
                        break
...
function CustomizationSystem:CreateAvatarGUI()
    for _, v in pairs(player.PlayerGui:GetChildren()) do
        if v.Name == "AvatarCustomizer" then v:Destroy() end
    end
    
    local screenGui = Instance.new("ScreenGui")
    screenGui.Name = "AvatarCustomizer"
    ...
    title.Size = UDim2.new(1, -80, 1, 0)
    title.Position = UDim2.new(0, 15, 0, 0)
    title.Text = "🎨 PERSONALIZAÇÃO DE AVATAR"
    title.TextColor3 = Color3.fromRGB(255, 255, 255)
    title.TextSize = 16
    title.Font = Enum.Font.GothamBold
    title.BackgroundTransparency = 1
    ...
    local categories = {"Animations", "Bodies", "Accessories", "Clothes", "Faces"}
    local tabButtons = {}
    local tabContents = {}
    ...
    for _, category in ipairs(categories) do
        ...
        for _, item in ipairs(self.Items[category] or {}) do
            ...
            itemFrame.BackgroundColor3 = Color3.fromRGB(40, 40, 55)
            itemFrame.BackgroundTransparency = 0.2
            itemFrame.BorderSizePixel = 0
            itemFrame.Parent = canvas
            ...
            applyBtn.Size = UDim2.new(0, 70, 0, 25)
            applyBtn.Position = UDim2.new(1, -155, 0.5, -12.5)
            ...
            applyBtn.MouseButton1Click:Connect(function()
                local success, msg = self:ApplyItem(category, item.id)
                print("[DAVI HUB]", msg)
                if success then
                    self:UpdateAppliedList()
                    showNotification("✅ " .. item.name .. " aplicado!", Color3.fromRGB(0, 200, 0))
                else
                    showNotification("❌ " .. msg, Color3.fromRGB(200, 0, 0))
                end
            end)
            
            local removeBtn = Instance.new("TextButton")
            removeBtn.Size = UDim2.new(0, 70, 0, 25)
            removeBtn.Position = UDim2.new(1, -80, 0.5, -12.5)
            ...
            removeBtn.MouseButton1Click:Connect(function()
                local success, msg = self:RemoveItem(category, item.id)
                print("[DAVI HUB]", msg)
                if success then
                    self:UpdateAppliedList()
                    showNotification("🗑️ " .. item.name .. " removido!", Color3.fromRGB(200, 200, 0))
                end
            end)
            ...
            yPos = yPos + 40
                ...
                canvas.Size = UDim2.new(1, 0, 0, yPos + 10)
        scrollFrame.CanvasSize = UDim2.new(0, 0, 0, canvas.Size.Y.Offset)
        tabContents[category] = scrollFrame
    end
    
    -- Seletor de cor
    local skinColorFrame = Instance.new("Frame")
    skinColorFrame.Size = UDim2.new(1, -20, 0, 40)
    skinColorFrame.Position = UDim2.new(0, 10, 0, 10)
    skinColorFrame.BackgroundColor3 = Color3.fromRGB(40, 40, 55)
    skinColorFrame.BackgroundTransparency = 0.2
    skinColorFrame.BorderSizePixel = 0
    skinColorFrame.Parent = contentFrame
    
    local skinColorCorner = Instance.new("UICorner")
    skinColorCorner.CornerRadius = UDim.new(0, 8)
    skinColorCorner.Parent = skinColorFrame
    
    local skinLabel = Instance.new("TextLabel")
    skinLabel.Size = UDim2.new(0, 150, 1, 0)
    skinLabel.Position = UDim2.new(0, 10, 0, 0)
    skinLabel.BackgroundTransparency = 1
    skinLabel.Text = "Cor de Pele:"
    ...
    skinLabel.Parent = skinColorFrame
    
    local colorButton = Instance.new("TextButton")
    colorButton.Size = UDim2.new(0, 180, 0, 30)
    colorButton.Position = UDim2.new(0, 160, 0.5, -15)
    colorButton.BackgroundColor3 = self.CurrentConfig.SkinColor or Color3.fromRGB(255, 200, 150)
    colorButton.BackgroundTransparency = 0.2
    colorButton.BorderSizePixel = 0
    colorButton.Text = "Selecionar Cor"
    colorButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    colorButton.TextSize = 12
    colorButton.Font = Enum.Font.Gotham
    colorButton.Parent = skinColorFrame
    ...
    colorButton.MouseButton1Click:Connect(function()
        ...
        colorPicker.BackgroundColor3 = Color3.fromRGB(20, 20, 35)
        ...
        pickerBorder.Color = Color3.fromRGB(255, 140, 0)
        pickerBorder.Thickness = 2
        pickerBorder.Transparency = 0.3
        pickerBorder.Parent = colorPicker
        
        local colors = {
            {Color3.fromRGB(255, 200, 150), "Clara"},
            {Color3.fromRGB(200, 150, 100), "Média"},
            {Color3.fromRGB(150, 100, 50), "Escura"},
            {Color3.fromRGB(255, 255, 255), "Branca"},
            {Color3.fromRGB(0, 0, 0), "Preta"},
            {Color3.fromRGB(255, 0, 0), "Vermelha"},
            {Color3.fromRGB(0, 255, 0), "Verde"},
            {Color3.fromRGB(0, 0, 255), "Azul"},
            {Color3.fromRGB(255, 255, 0), "Amarela"},
            {Color3.fromRGB(255, 0, 255), "Roxa"},
        ...
        for i = 1, #colors, 3 do
            for j = 0, 2 do
                ...
                if idx <= #colors then
                    ...
                    btn.Position = UDim2.new(j * 0.333, 5, 0, yPos)
                    btn.BackgroundColor3 = colors[idx][1]
                    btn.BackgroundTransparency = 0.2
                    btn.BorderSizePixel = 0
                    btn.Text = colors[idx][2]
                    btn.TextColor3 = Color3.fromRGB(255, 255, 255)
                    btn.TextSize = 11
                    btn.Font = Enum.Font.GothamBold
                    ...
                    btn.MouseButton1Click:Connect(function()
                        self:SetSkinColor(colors[idx][1])
                        colorButton.BackgroundColor3 = colors[idx][1]
                        colorPicker:Destroy()
                        showNotification("🎨 Cor de pele atualizada!", Color3.fromRGB(0, 200, 200))
                    end)
                end
            end
            yPos = yPos + 50
        ...
        closePicker.Position = UDim2.new(0.5, -50, 0, yPos + 10)
        closePicker.BackgroundColor3 = Color3.fromRGB(200, 50, 50)
        closePicker.BackgroundTransparency = 0.2
    ...
    -- Lista de itens aplicados
    local appliedFrame = Instance.new("Frame")
    appliedFrame.Size = UDim2.new(1, -20, 0, 60)
    appliedFrame.Position = UDim2.new(0, 10, 0, 55)
    appliedFrame.BackgroundColor3 = Color3.fromRGB(40, 40, 55)
    appliedFrame.BackgroundTransparency = 0.2
    appliedFrame.BorderSizePixel = 0
    appliedFrame.Parent = contentFrame
    
    local appliedCorner = Instance.new("UICorner")
    appliedCorner.CornerRadius = UDim.new(0, 8)
    appliedCorner.Parent = appliedFrame
    
    local appliedLabel = Instance.new("TextLabel")
    appliedLabel.Size = UDim2.new(1, 0, 0, 20)
    appliedLabel.Position = UDim2.new(0, 10, 0, 0)
    appliedLabel.BackgroundTransparency = 1
    appliedLabel.Text = "🔄 Itens Aplicados:"
    appliedLabel.TextColor3 = Color3.fromRGB(255, 165, 0)
    appliedLabel.TextSize = 12
    appliedLabel.TextXAlignment = Enum.TextXAlignment.Left
    appliedLabel.Font = Enum.Font.GothamBold
    appliedLabel.Parent = appliedFrame
    
    local appliedList = Instance.new("ScrollingFrame")
    appliedList.Size = UDim2.new(1, -10, 0, 35)
    appliedList.Position = UDim2.new(0, 5, 0, 22)
    appliedList.BackgroundTransparency = 1
    appliedList.BorderSizePixel = 0
    appliedList.CanvasSize = UDim2.new(0, 0, 0, 0)
    appliedList.ScrollBarThickness = 4
    appliedList.Parent = appliedFrame
    
    local appliedCanvas = Instance.new("Frame")
    appliedCanvas.Size = UDim2.new(1, 0, 0, 0)
    appliedCanvas.BackgroundTransparency = 1
    appliedCanvas.Parent = appliedList
    
    function CustomizationSystem:UpdateAppliedList()
        for _, child in ipairs(appliedCanvas:GetChildren()) do
            child:Destroy()
        end
        
        local items = self:GetAppliedItems()
        local xPos = 5
        ...
        for _, item in ipairs(items) do
            ...
            label.BackgroundColor3 = Color3.fromRGB(60, 60, 80)
            label.BackgroundTransparency = 0.2
            label.BorderSizePixel = 0
            label.Text = item.Name or tostring(item.Id)
            label.TextColor3 = Color3.fromRGB(255, 255, 255)
            label.TextSize = 9
            label.Font = Enum.Font.Gotham
            label.Parent = appliedCanvas
        ...
        appliedCanvas.Size = UDim2.new(0, math.max(10, xPos), 0, 30)
        appliedList.CanvasSize = UDim2.new(0, appliedCanvas.Size.X.Offset, 0, 30)
    end
    ...
    function SwitchTab(category)
        ...
        if tabContents[category] then
            tabContents[category].Visible = true
        end
        if tabButtons[category] then
            tabButtons[category].TextColor3 = Color3.fromRGB(255, 165, 0)
        end
    end
...
function CustomizationSystem:Initialize()
    ...
    print("✅ Sistema de Personalização de Avatar carregado!")
    print("📌 Comandos: OpenAvatarCustomizer() | ApplyItem('categoria', id) | RemoveItem('categoria', id)")
end

-- Inicializar
CustomizationSystem:Initialize()

-- ============================================================
-- COMANDOS GLOBAIS
-- ============================================================

_G.OpenAvatarCustomizer = function()
    CustomizationSystem:CreateAvatarGUI()
end

_G.ApplyItem = function(category, id)
    local success, msg = CustomizationSystem:ApplyItem(category, id)
    print("[DAVI HUB]", msg)
end

_G.RemoveItem = function(category, id)
    local success, msg = CustomizationSystem:RemoveItem(category, id)
    print("[DAVI HUB]", msg)
end

_G.SetSkinColor = function(color)
    CustomizationSystem:SetSkinColor(color)
end

print("🎨 Comandos de personalização disponíveis:")
print("  OpenAvatarCustomizer() - Abrir personalizador")
print("  ApplyItem('categoria', id) - Aplicar item")
print("  RemoveItem('categoria', id) - Remover item")
print("  SetSkinColor(Color3) - Mudar cor de pele")
-- ============================================================
